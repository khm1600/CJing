C# with alternative keywords in Chinese (Simplified) characters similar to the one proposed in [issue #993 of dotnet/csharplang](https://github.com/dotnet/csharplang/issues/993).  
